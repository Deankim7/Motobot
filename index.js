...
/////////////////
const BotName = 'MOTO BOT☄'; 
const instagram = 'https://instagram.com/lzx.dean_rerly'; 
const telegram = 'https://t.me/reuzzz'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/Deankim_7';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Lzx.dean_rerly')
